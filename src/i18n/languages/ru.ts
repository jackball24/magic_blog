...
export const ru: Translation = {
	...
	[Key.musicVisualizerDescription]: "Иммерсивный 3D-ландшафт музыки",
	...
	// ===== 页面级描述 =====
	[Key.archiveDescription]: "Все статьи по времени, категориям и тегам.",
	[Key.tagGraphPageTitle]: "Граф тегов",
	[Key.tagGraphPageDescription]: "Связи статей через граф категорий и тегов.",
	...
	[Key.listDescription]:
		"Просматривайте все статьи блога по темам, категориям, тегам, дате публикации и популярности.",
